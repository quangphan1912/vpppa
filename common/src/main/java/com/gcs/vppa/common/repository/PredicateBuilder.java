...
import com.gcs.vppa.common.repository.ArrayPredicate.ArrayComparisonOperator;
...
public final class PredicateBuilder {
   ...
   * @return the predicate
   */
  private static Predicate buildEqual(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
   ...
   * @return the predicate
   */
  private static Predicate buildNotEqual(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
    Object value) {
    return criteriaBuilder.or(criteriaBuilder.notEqual(root.get(key), value), buildIsNull(root, criteriaBuilder, key));
  }
   ...
   * @return the predicate
   */
  private static Predicate buildLike(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
    Object value) {
   ...
   * @return the predicate
   */
  private static Predicate buildNotLike(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
    Object value) {
   ...
   * @return the predicate
   */
  private static Predicate buildLessThan(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
    Object value, String dataType) {
    Predicate predicate = null;
    ...
    switch (dataType) {
      ...
      case DataType.DATETIME:
        predicate = criteriaBuilder.lessThan(root.get(key).as(Date.class), DateTimeUtil.toDateTime(value.toString()));
        break;
   ...
   * @return the predicate
   */
  private static Predicate buildEqualIn(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
    Object value, String dataType) {
   ...
   * @return the predicate
   */
  private static Predicate buildLikeIn(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key,
    Object value) {
    String[] valueItemList = value.toString().split(",");
    Predicate[] predicateInList = new Predicate[valueItemList.length];
   ...
   * @return the predicate
   */
  private static Predicate buildContainAny(From<?, ?> root, CriteriaBuilder criteriaBuilder, String key, Object value) {
