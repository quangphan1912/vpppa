...
public class DecryptionException extends RuntimeException {
   ...
   */
  public DecryptionException(final String errorCode, final String message) {
    super(message);
   ...
   */
  public DecryptionException(final String errorCode, final String message, final Throwable cause) {
    super(message, cause);
    this.errorCode = errorCode;
  }
}
