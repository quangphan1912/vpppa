 ...
 */
public class ArrayPredicate extends AbstractSimplePredicate
  ...
  public ArrayPredicate(
    ...
    ArrayComparisonOperator comparisonOperator,
  ...
  public ArrayPredicate(
    ...
    if (ValueHandlerFactory.isNumeric(rightHandSide.getJavaType())) {
      this.leftHandSide = new LiteralExpression<Object>(
        criteriaBuilder,
   ...
   */
  @SuppressWarnings({"unchecked"})
  public <N extends Number> ArrayPredicate(
    CriteriaBuilderImpl criteriaBuilder,
    ArrayComparisonOperator comparisonOperator,
  ...
  */
  ...
  public String render(boolean isNegated, RenderingContext renderingContext) {
    return ((Renderable) getLeftHandOperand()).render(renderingContext)
      ...
      + (String.format("ANY(%s)", renderingContext));
  }
}
