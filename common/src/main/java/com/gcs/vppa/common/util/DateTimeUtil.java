...
import com.gcs.vppa.common.exception.UserDefinedException;
...
public final class DateTimeUtil {
  ...
  public static Integer compare(Date date1, LocalTime localTime1, Date date2, LocalTime localTime2) {
    log.debug("compareDateLocalTime - date1=[{}], localTime1=[{}], date2=[{}], localTime2=[{}]...", date1, localTime1,
      date2,
      localTime2);
  ...
  public static Boolean isInRange(LocalTime checkTime, LocalTime fromTime, LocalTime endTime) {
    ...
    if (standardCheckTime.equals(standardFromTime)
      || standardCheckTime.equals(standardEndTime)
   ...
   * @param date
   *            the date
   * @param numMiliSeconds
   *            the num mili seconds
   * @return the date
   */
  ...
  public static LocalDateTime formatDateTime(String value) {
    ...
    if (date != null && value.equals(sdf.format(date))) {
      ...
      dateTime = LocalDateTime.parse(localDate.atTime(LocalTime.of(0, 0, 0))
  ...
  public static LocalDateTime formatExpiredDate(String value) {
    ...
    if (date != null && value.equals(sdf.format(date))) {
      LocalDate localDate = LocalDate.ofInstant(date.toInstant(), ZoneId.systemDefault());
      dateTime = LocalDateTime.parse(localDate.atTime(LocalTime.of(23, 59, 59))
        .format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
    } else {
      dateTime = LocalDateTime.parse(value);
    }
