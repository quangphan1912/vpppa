...
public class ResponseTemplate implements Serializable {
   ...
   *            the errors
   */
  public ResponseTemplate(Integer status, String message, List<ErrorDetail> errors) {
    super();
   ...
   *            the errors
   */
  public ResponseTemplate(HttpStatus status, String message, List<ErrorDetail> errors) {
    super();
    this.timestamp = System.currentTimeMillis();
   ...
   */
  public ResponseTemplate(HttpStatus status, ErrorDetail error) {
    super();
    this.timestamp = System.currentTimeMillis();
    this.status = status.value();
