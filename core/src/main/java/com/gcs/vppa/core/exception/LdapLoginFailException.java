 ...
 */
@Setter
public class LdapLoginFailException extends RuntimeException {
   ...
   *            the error text
   */
  public LdapLoginFailException(final String errorCode, final String errorText) {
    super(errorText);
   ...
   *            the cause
   */
  public LdapLoginFailException(final String errorCode, final String errorText, final Throwable cause) {
