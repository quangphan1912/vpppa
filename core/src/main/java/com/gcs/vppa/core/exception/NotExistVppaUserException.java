...
/**
 * The Class NotExistVppaUserException.
 *
 ...
 */
@Setter
public class NotExistVppaUserException extends RuntimeException {
   ...
   */
  public NotExistVppaUserException() {
    super();
    this.errorCode = null;
   ...
   *            the error text
   */
  public NotExistVppaUserException(final String errorCode, final String errorText) {
    super(errorText);
   ...
   *            the cause
   */
  public NotExistVppaUserException(final String errorCode, final String errorText, final Throwable cause) {
